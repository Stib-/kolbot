function Diablo() {
	...
	this.followPath = function (path, sortfunc) {
		...
		for (i = 0; i < path.length; i += 2) {
			...
			Attack.clear(35, 0, false, sortfunc);
		}
	};

	// path coordinates
	this.entranceToStar = [7794, 5517, 7791, 5491, 7768, 5459, 7775, 5424, 7804, 5440, 7817, 5458, 7777, 5408, 7769, 5379, 7777, 5357, 7809, 5359, 7805, 5330, 7780, 5317];
